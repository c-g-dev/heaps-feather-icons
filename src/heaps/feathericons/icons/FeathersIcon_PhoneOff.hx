...
import heaps.feathericons.utils.GraphicsCommands;
 ...
 class FeathersIcon_PhoneOff extends heaps.feathericons.utils.GraphicsStore {
	public function getStrokes(): Array<GraphicsCommands> {
		return [
			...
			GraphicsCommands.MoveTo(10.68, 13.31),
			GraphicsCommands.MoveTo(10.68, 13.31),
			GraphicsCommands.DrawArc(10.68, 13.31, 16, 16, 0, 0, 0, 3.41, 2.6),
			...
			GraphicsCommands.DrawArc(20.28, 14.89, 2, 2, 0, 0, 1, 1.72, 2),
			GraphicsCommands.MoveTo(22, 16.89),
			GraphicsCommands.LineTo(22, 19.89),
			GraphicsCommands.MoveTo(22, 19.89),
			GraphicsCommands.DrawArc(22, 19.89, 2, 2, 0, 0, 1, -2.18, 2),
			GraphicsCommands.MoveTo(19.82, 21.89),
			GraphicsCommands.DrawArc(19.82, 21.89, 19.79, 19.79, 0, 0, 1, -8.63, -3.07),
			GraphicsCommands.MoveTo(11.19, 18.82),
			GraphicsCommands.DrawArc(11.19, 18.82, 19.42, 19.42, 0, 0, 1, -3.33, -2.67),
			GraphicsCommands.MoveTo(7.86, 16.15),
			GraphicsCommands.MoveTo(5.19, 12.81),
			GraphicsCommands.MoveTo(5.19, 12.81),
			GraphicsCommands.DrawArc(5.19, 12.81, 19.79, 19.79, 0, 0, 1, -3.07, -8.63),
