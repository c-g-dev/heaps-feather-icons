...
import heaps.feathericons.utils.GraphicsCommands;
 ...
 class FeathersIcon_PhoneForwarded extends heaps.feathericons.utils.GraphicsStore {
	public function getStrokes(): Array<GraphicsCommands> {
		return [
			...
			GraphicsCommands.MoveTo(19, 1),
			GraphicsCommands.LineTo(23, 5),
			GraphicsCommands.MoveTo(23, 5),
