...
import heaps.feathericons.utils.GraphicsCommands;
 ...
 class FeathersIcon_PhoneCall extends heaps.feathericons.utils.GraphicsStore {
	public function getStrokes(): Array<GraphicsCommands> {
		return [
			...
			GraphicsCommands.MoveTo(15.05, 5),
			GraphicsCommands.MoveTo(15.05, 5),
			GraphicsCommands.DrawArc(15.05, 5, 5, 5, 0, 0, 1, 3.95, 3.95),
			GraphicsCommands.MoveTo(19, 8.95),
			GraphicsCommands.MoveTo(15.05, 1),
			GraphicsCommands.MoveTo(15.05, 1),
			GraphicsCommands.DrawArc(15.05, 1, 9, 9, 0, 0, 1, 7.95, 7.94),
			GraphicsCommands.MoveTo(23, 8.94),
			...
			GraphicsCommands.MoveTo(22, 16.92),
			GraphicsCommands.MoveTo(22, 16.92),
			GraphicsCommands.LineTo(15.05, 5),
		];
	}
}