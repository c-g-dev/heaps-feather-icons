...
import heaps.feathericons.utils.GraphicsCommands;
 ...
 class FeathersIcon_Codesandbox extends heaps.feathericons.utils.GraphicsStore {
	public function getStrokes(): Array<GraphicsCommands> {
		return [
			...
			GraphicsCommands.MoveTo(21, 16),
			GraphicsCommands.LineTo(21, 8),
			GraphicsCommands.MoveTo(7.5, 4.21),
			GraphicsCommands.LineTo(12, 6.81),
			GraphicsCommands.MoveTo(12, 6.81),
			GraphicsCommands.LineTo(16.5, 4.21),
			GraphicsCommands.MoveTo(16.5, 4.21),
			GraphicsCommands.MoveTo(7.5, 19.79),
			GraphicsCommands.LineTo(7.5, 14.6),
			GraphicsCommands.MoveTo(7.5, 14.6),
			GraphicsCommands.LineTo(3, 12),
			GraphicsCommands.MoveTo(3, 12),
			GraphicsCommands.MoveTo(21, 12),
			GraphicsCommands.LineTo(16.5, 14.6),
			GraphicsCommands.MoveTo(16.5, 14.6),
			GraphicsCommands.LineTo(16.5, 19.79),
			GraphicsCommands.MoveTo(16.5, 19.79),
