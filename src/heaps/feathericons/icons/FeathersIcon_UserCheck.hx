...
import heaps.feathericons.utils.GraphicsCommands;
 ...
 class FeathersIcon_UserCheck extends heaps.feathericons.utils.GraphicsStore {
	public function getStrokes(): Array<GraphicsCommands> {
		return [
			...
			GraphicsCommands.LineTo(19, 13),
			GraphicsCommands.MoveTo(19, 13),
			GraphicsCommands.LineTo(23, 9),
			GraphicsCommands.MoveTo(23, 9),
		];
	}
}